...
public class Value extends JFrame {
    ...
    MyAcc cli = new MyAcc(1000, "12345", 10, "");
    ...
    JButton ok = new JButton("Add Deposit");
    //JButton Adddep=new JButton("Add Withdraw");

    public Value(Atm3 ma) {
        Atm3 m = ma;
        setLayout(null);
        add(b0);
        ...
        ok.addActionListener(new ActionListener() {
            ...
            @Override
            public void actionPerformed(ActionEvent e) {
                //Operations p = new Operations(cli);
                //p.setVisible(true);
                //p.setSize(500, 600);
                m.desposite(b.getText());
                setVisible(false);
